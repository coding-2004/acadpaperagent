            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between h-16 items-center">
                    ...
                    <div className="hidden md:flex items-center space-x-8">
                        ...
                        <Link to="/signup" className="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2 rounded-full text-sm font-semibold shadow-lg shadow-blue-500/30 transition-all hover:scale-105 active:scale-95">
                            Get Started
                        </Link>
                    </div>
                    ...
                    <div className="md:hidden flex items-center">
                        <button
                            ...
                            className="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 outline-none"
                        >
            ...
            {isOpen && (
                <div className="md:hidden bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 animate-in slide-in-from-top duration-300">
                    <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                        ...
                        <Link to="/login" onClick={() => setIsOpen(false)} className="block px-3 py-2 text-base font-medium text-gray-600 dark:text-gray-300 hover:bg-blue-50 dark:hover:bg-blue-900/30 rounded-md">Log In</Link>
                        <Link to="/signup" onClick={() => setIsOpen(false)} className="w-full mt-2 bg-blue-600 text-white block text-center px-3 py-3 rounded-md text-base font-semibold">
                            Get Started
                        </Link>
                    </div>
                </div>
