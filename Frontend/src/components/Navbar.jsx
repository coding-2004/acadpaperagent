                    ...
                    <div className="hidden md:flex items-center space-x-6">
                        ...
                        {user ? (
                            <>
                                ...
                                <Link to="/reading-lists" className="flex items-center gap-2 text-sm font-medium text-gray-600 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-400 transition-colors">
                    ...
                    <div className="px-4 pt-4 pb-6 space-y-3">
                        ...
                        {user ? (
                            <>
                                ...
                                <Link to="/reading-lists" onClick={() => setIsOpen(false)} className="block px-3 py-2 text-base font-medium text-gray-600 dark:text-gray-300 hover:bg-blue-50 dark:hover:bg-blue-900/30 rounded-xl transition-colors">My Lists</Link>
                                <button
                                    onClick={handleLogout}
